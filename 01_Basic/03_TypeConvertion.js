...
let string = "String"   
let Converted = Number(string)        //String => Number , non-numeric string will be converted to "NaN"(i.e. Not a Number , it is still a number datatype) value and if the string is empty (i.e. "") ,it will return 0
...
let number = 69  
let Converted4 = String(number)       //String => String lead to "NaN" i.e. Not a String value and if the string is empty i.e. "" , it will return 0
...
// empty string("") ,0,Bigint 0n,undefined,null are falsy(false) value when converted into bool while empty array,object,function are truthy(true) value